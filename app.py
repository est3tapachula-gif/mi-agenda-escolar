...
# Selector de día / Fecha actual
dias = ["Lunes", "Martes", "Miércoles", "Jueves", "Viernes", "Sábado", "Domingo"]
hoy = datetime.date.today()
nombre_dia_hoy = dias[hoy.weekday()]

# Barra lateral para navegación
opcion_menu = st.sidebar.radio("Navegación", ["Inicio / Clases de Hoy", "Registrar Nueva Clase", "Tareas y Avisos"])
    ...
    if clases_hoy:
        for clase in clases_hoy:
            ...
            with st.expander(f"⏰ {hora_ini} - {hora_fin} | {materia} ({grupo})"):
                ...
                # Botón de enlace a Google Drive
                if link_drive:
...
# ---------------------------------------------------------
# PANTALLA 2: REGISTRAR NUEVA CLASE
# ---------------------------------------------------------
    ...
    with st.form("form_clase"):
        ...
        dia_semana = st.selectbox("Día de la semana", dias)
